...
int main()
{
  ...
  std::vector<double> four_momentum_electron{1, 0, 0};
  particle electron1("e", four_momentum_electron);
  particle electron2("e", four_momentum_electron);

  std::vector<double> four_momentum_muon{1, 0, 0};
  particle muon1("mu", four_momentum_muon);
  particle muon2("mu", four_momentum_muon);
  particle muon3("mu", four_momentum_muon);
  particle muon4("mu", four_momentum_muon);

  std::vector<double> four_momentum_anti_e{-1, 0, 0};
  particle antielectron1("e", four_momentum_anti_e);
  antielectron1.charge_conjugate();

  std::vector<double> four_momentum_anti_mu{0, 1, 0};
  particle antimuon1("mu", four_momentum_anti_mu);
  ...
  std::cout << "Dot product of the first two muons: " << dot_product_muons << "\n";
